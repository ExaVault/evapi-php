...
/**
 * RenameResources Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RenameResources implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RenameResources';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_name'] === null) {
            $invalid_properties[] = "'new_name' can't be null";
        }
    ...
    /**
     * Sets file_path
     * @param string $file_path Remote path of the file or folder to rename.
     * @return $this
     */
