...
/**
 * MoveResources Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MoveResources implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MoveResources';
    ...
    /**
     * Sets file_paths
     * @param string[] $file_paths Array containing file/folder paths to move.
     * @return $this
     */
     ...
     * @param string $destination_path Remote destination path to move files/folders to.
     * @return $this
     */
