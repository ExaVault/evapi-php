...
/**
 * CopyResourcesRequestBody Class Doc Comment
 *
 * @category Class
 * @package  ExaVault
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CopyResourcesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CopyResourcesRequestBody';
...
'parent_resource' => 'getParentResource'    ];
     ...
     * Sets resources
     *
     * @param string[] $resources Resource identifier(s) of items to be copied to a new location
     *
     * @return $this
     */
     ...
     *
     * @param string $parent_resource Resource identifier for folder where items will be copied to.
     *
     * @return $this
     */
