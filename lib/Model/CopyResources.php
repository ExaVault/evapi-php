...
/**
 * CopyResources Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CopyResources implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CopyResources';
    ...
    protected static $setters = [
        ...
        'destination_path' => 'setDestinationPath'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['destination_path'] = isset($data['destination_path']) ? $data['destination_path'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['file_paths'] === null) {
            $invalid_properties[] = "'file_paths' can't be null";
        }
        if ($this->container['destination_path'] === null) {
            $invalid_properties[] = "'destination_path' can't be null";
        }
    ...
    /**
     * Sets file_paths
     * @param string[] $file_paths Array containing file/folder paths to copy.
     * @return $this
     */
    ...
    {
        return $this->container['destination_path'];
    }

    /**
     * Sets destination_path
     * @param string $destination_path Remote destination path to copy files/folders to.
     * @return $this
     */
    public function setDestinationPath($destination_path)
    {
        $this->container['destination_path'] = $destination_path;
