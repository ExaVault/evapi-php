 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateShare implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createShare';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['access_mode'] === null) {
            $invalid_properties[] = "'access_mode' can't be null";
        }
    ...
    {
        $allowed_values = $this->getAccessModeAllowableValues();
        if (!in_array($access_mode, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'access_mode', must be one of '%s'",
                    implode("', '", $allowed_values)
