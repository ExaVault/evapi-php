 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateUser implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['welcome_email'] = isset($data['welcome_email']) ? $data['welcome_email'] : false;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destination_folder'] === null) {
            $invalid_properties[] = "'destination_folder' can't be null";
        }
     ...
     * @param string $destination_folder The path to the user's home folder. For the account root, specify `/`. Otherwise, use standard Unix path format, e.g. `/path/to/some/dir`. The user will be locked to this directory and unable to move 'up' in the account.
     * @return $this
     */
    ...
    {
        $allowed_values = $this->getPermissionsAllowableValues();
        if (!in_array($permissions, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'permissions', must be one of '%s'",
                    implode("', '", $allowed_values)
    ...
    /**
     * Sets expiration
     * @param string $expiration Optional timestamp when the user should expire, formatted `YYYY-mm-dd hh:mm:ss`.
     * @return $this
     */
