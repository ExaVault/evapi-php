...
/**
 * CreateNotification Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateNotification implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateNotification';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['send_email'] === null) {
            $invalid_properties[] = "'send_email' can't be null";
        }
    ...
    /**
     * Sets type
     * @param string $type Type of resource you're setting the notification on.
     * @return $this
     */
    ...
    /**
     * Sets usernames
     * @param string[] $usernames Determines which users should trigger the notification. Either one of the values above, or an array of usernames.
     * @return $this
     */
    ...
    /**
     * Sets emails
     * @param string[] $emails Email addresses to send the notification to. If not specified, sends to the authenticated user.
     * @return $this
     */
