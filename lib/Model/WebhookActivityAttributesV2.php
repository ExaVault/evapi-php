...
/**
 * WebhookActivityAttributesV2 Class Doc Comment
 *
 * @category Class
 * @package  ExaVault
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebhookActivityAttributesV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebhookActivityAttributesV2';
...
'ipAddress' => 'string',
'response' => 'string',
'details' => '\ExaVault\Model\WebhookV2Details',
'webhookPath' => 'string',
'resourcePath' => 'string',
'username' => 'string',
'created' => 'string'    ];
...
self::EVENT_SHARESFORM_SUBMIT,        ];
     ...
     * Sets webhookFormat
     *
     * @param string $webhookFormat What version of webhook message is being sent `v2`
     *
     * @return $this
     */
     ...
     * Gets details
     *
     * @return \ExaVault\Model\WebhookV2Details
     */
     ...
     * Sets details
     *
     * @param \ExaVault\Model\WebhookV2Details $details details
     *
     * @return $this
     */
