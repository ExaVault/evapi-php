...
class NotificationApi
{
     ...
     * @param \Swagger\Client\Model\CreateNotification $create_notification  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\NotificationResponse
     */
    public function createNotification($api_key, $create_notification = null)
    {
        list($response) = $this->createNotificationWithHttpInfo($api_key, $create_notification);
        return $response;
    }
     ...
     */
    public function createNotificationWithHttpInfo($api_key, $create_notification = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_notification)) {
            $_tempBody = $create_notification;
        }
