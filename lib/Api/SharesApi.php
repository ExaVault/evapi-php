...
class SharesApi
{
     ...
     * @return \Swagger\Client\Model\RegularShareResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\RegularShareResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addShareWithHttpInfo($ev_api_key, $ev_access_token, $body = null)
    {
        $returnType = '\Swagger\Client\Model\RegularShareResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\RegularShareResponse',
    ...
    protected function listSharesRequest($ev_api_key, $ev_access_token, $offset = null, $limit = '100', $scope = null, $sort = null, $type = null, $include = null, $name = null, $recipient = null, $message = null, $username = null, $search = null)
    {
        ...
        // query params
        if ($recipient !== null) {
            $queryParams['recipient'] = ObjectSerializer::toQueryValue($recipient);
        }
        // query params
        if ($message !== null) {
