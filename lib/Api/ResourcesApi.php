...
class ResourcesApi
{
    ...
    protected function downloadRequest($ev_api_key, $ev_access_token, $resources, $download_name = null, $polling = null, $polling_zip_name = null)
    {
        ...
        if ($resources !== null) {
            $queryParams['resources[]'] = ObjectSerializer::toQueryValue($resources);
        }
        // query params
    ...
    protected function uploadFileRequest($ev_api_key, $ev_access_token, $path, $file_size, $file = null, $offset_bytes = null, $resume = 'true', $allow_overwrite = 'false')
    {
        ...
        // query params
        if ($file_size !== null) {
            $queryParams['fileSize'] = ObjectSerializer::toQueryValue($file_size);
        }
        // query params
        if ($resume !== null) {
            $queryParams['resume'] = ObjectSerializer::toQueryValue($resume);
        }
        // query params
        if ($allow_overwrite !== null) {
            $queryParams['allowOverwrite'] = ObjectSerializer::toQueryValue($allow_overwrite);
        }
        // header params
        if ($ev_api_key !== null) {
            $headerParams['ev-api-key'] = ObjectSerializer::toHeaderValue($ev_api_key);
