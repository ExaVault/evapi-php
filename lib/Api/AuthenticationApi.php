...
class AuthenticationApi
{
     ...
     * @param \Swagger\Client\Model\AuthenticateUser $authenticate_user  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\AuthResponse
     */
    public function authenticateUser($api_key, $authenticate_user = null)
    {
        list($response) = $this->authenticateUserWithHttpInfo($api_key, $authenticate_user);
        return $response;
    }
     ...
     */
    public function authenticateUserWithHttpInfo($api_key, $authenticate_user = null)
    {
     ...
     *
     * @param string $api_key API key required to make the API call. (required)
     * @param \Swagger\Client\Model\LogoutUser $logout_user  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Response
     */
    public function logoutUser($api_key, $logout_user = null)
    {
        list($response) = $this->logoutUserWithHttpInfo($api_key, $logout_user);
        return $response;
    }
     ...
     */
    public function logoutUserWithHttpInfo($api_key, $logout_user = null)
    {
        // verify the required parameter 'api_key' is set
        if ($api_key === null) {
