...
class ShareApi
{
     ...
     * @param \Swagger\Client\Model\CreateShare $create_share  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ShareResponse
     */
    public function createShare($api_key, $create_share = null)
    {
        list($response) = $this->createShareWithHttpInfo($api_key, $create_share);
        return $response;
    }
     ...
     */
    public function createShareWithHttpInfo($api_key, $create_share = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_share)) {
            $_tempBody = $create_share;
        }
     ...
     *
     * @param string $api_key API key required to make the API call. (required)
     * @param \Swagger\Client\Model\UpdateShare $update_share  (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Response
     */
    public function updateShare($api_key, $update_share = null)
    {
        list($response) = $this->updateShareWithHttpInfo($api_key, $update_share);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateShareWithHttpInfo($api_key, $update_share = null)
    {
        // verify the required parameter 'api_key' is set
        if ($api_key === null) {
        ...
        // body params
        $_tempBody = null;
        if (isset($update_share)) {
            $_tempBody = $update_share;
        }
